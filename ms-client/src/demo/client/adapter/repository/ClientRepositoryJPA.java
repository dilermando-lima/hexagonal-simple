package demo.client.adapter.repository;
...
@Repository
public interface ClientRepositoryJPA extends ClientRepositoryGateway , CrudRepository<ClientEntity,String> {
    ...
    @Query("""
    SELECT c FROM demo.client.adapter.repository.ClientEntity c WHERE 
